...
type
  TfrmProfitLossOps = class(TfrmDefaultReport)
...
var
  frmProfitLossOps: TfrmProfitLossOps;
...
procedure TfrmProfitLossOps.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmProfitLossOps.btnRefreshClick(Sender: TObject);
begin
  inherited;
  LoadData;
end;

procedure TfrmProfitLossOps.cbBulanPropertiesEditValueChanged(Sender: TObject);
begin
  inherited;
  UpdatePeriode;
end;

procedure TfrmProfitLossOps.chkPeriodePropertiesEditValueChanged(Sender: TObject);
begin
  inherited;
...
procedure TfrmProfitLossOps.cxGrdMainStylesGetContentStyle(
...
function TfrmProfitLossOps.GetGroupName: string;
begin
  Result := 'Manajemen';
end;

procedure TfrmProfitLossOps.LoadData;
var
  S: string;
begin
  if CDS <> nil then
...
procedure TfrmProfitLossOps.spTahunPropertiesEditValueChanged(Sender: TObject);
begin
  inherited;
  UpdatePeriode;
end;

procedure TfrmProfitLossOps.UpdatePeriode;
var
  lDate: TDatetime;
begin

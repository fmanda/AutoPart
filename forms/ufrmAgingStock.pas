...
begin
  ...
  Try
    ...
    S := 'select a.ITEM_ID, b.KODE, b.NAMA, e.NAMA as ITEMGROUP, F.NAMA AS MERK,'
        +' D.UOM AS UOM, C.KONVERSI, CASE WHEN ISNULL(C.HARGAAVG,0) = 0 THEN C.HARGABELI ELSE C.HARGABELI END  AS HARGAAVG,'
        +' A.TOTALPCS/C.KONVERSI AS TOTALQTY,'
        +' CASE WHEN ISNULL(C.HARGAAVG,0) = 0 THEN C.HARGABELI ELSE C.HARGABELI END *A.TOTALPCS/C.KONVERSI AS TOTALVALUE,'
        ...
        +' CASE WHEN ISNULL(C.HARGAAVG,0) = 0 THEN C.HARGABELI ELSE C.HARGABELI END *A.RANGE1/C.KONVERSI AS VALUERANGE1,'
        +' CASE WHEN ISNULL(C.HARGAAVG,0) = 0 THEN C.HARGABELI ELSE C.HARGABELI END *A.RANGE2/C.KONVERSI AS VALUERANGE2,'
        +' CASE WHEN ISNULL(C.HARGAAVG,0) = 0 THEN C.HARGABELI ELSE C.HARGABELI END *A.RANGE3/C.KONVERSI AS VALUERANGE3,'
        +' CASE WHEN ISNULL(C.HARGAAVG,0) = 0 THEN C.HARGABELI ELSE C.HARGABELI END *A.RANGE4/C.KONVERSI AS VALUERANGE4,'
        +' CASE WHEN ISNULL(C.HARGAAVG,0) = 0 THEN C.HARGABELI ELSE C.HARGABELI END *A.RANGE5/C.KONVERSI AS VALUERANGE5'

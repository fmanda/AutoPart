...
begin
  inherited;
  S := 'SELECT A.INVOICENO, A.TRANSDATE, A.DUEDATE, B.NAMA AS SUPPLIER, E.KODE AS KODEITEM,'
      +' E.NAMA AS CUSTOMER, H.NAMA AS SALESMAN, F.UOM, ABS(D.QTY) AS QTY, D.HARGA, D.DISCOUNT,'

...
function TSupplier.GenerateNo: String;
var
  aPrefix: string;
  lNum: Integer;
  S: string;
begin
  lNum := 0;
  aPrefix := 'S' + FormatDateTime('YY',Now())+'.';

  S := 'SELECT MAX(Kode) FROM TSupplier WHERE Kode LIKE ' + QuotedStr(aPrefix + '%');
